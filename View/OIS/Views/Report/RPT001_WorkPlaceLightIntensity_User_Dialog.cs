...
{
    public partial class RPT001_WorkPlaceLightIntensity_User_Dialog : rBaseForm
    {
        #region "Enum"
        private enum eCol
        {
        ...
        #region "Constructor"
        public RPT001_WorkPlaceLightIntensity_User_Dialog(DataTable dataList)
        {
            try
            {
                InitializeComponent();
        ...
        private void InitialScreen()
        {
            ...
            gvDetail.SetColumnComboBox((int)eCol.MEASURED_BY, vmCombo.GetComboUser(), DataGridViewComboBoxDisplayStyle.Nothing);
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            if (txtSearch.StringValue != null)
            {
                ...
                dr[(int)eCol.MEASURED_BY] = txtSearch.StringValue;
