...
{
    public partial class ToolPickDialog : rBaseForm
    {
        #region "Enum"
        private enum eCol
        {
        ...
        private SortableBindingList<sp_MAS308_GetToolPick_Result> dataList;
        private int id;

        public sp_MAS308_GetToolPick_Result SelectedData;
        public int RowCount
        {
            get
            {
        ...
        #region "Constructor"
        public ToolPickDialog(string strSearch)
        {
            InitializeComponent();
            InitialScreen(strSearch);
        }
        public ToolPickDialog(int ID)
        {
            InitializeComponent();
            id = ID;
            InitialScreen(null);
        ...
        #region "Event"
        private void ToolPickDialog_Load(object sender, EventArgs e)
        {
        ...
        private void gvDetail_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                SelectedData = gvDetail.GetDataBound(e.RowIndex) as sp_MAS308_GetToolPick_Result;
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            gvDetail.DataSource = new SortableBindingList<sp_MAS308_GetToolPick_Result>(result);
