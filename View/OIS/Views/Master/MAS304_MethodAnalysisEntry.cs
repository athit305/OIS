...
namespace OIS.Views
{
    public partial class MAS304_MethodAnalysisEntry : rBaseDialog
    {
        #region "Enum"
        private enum eCol
        {
        ...
        private sp_MAS304_GetMethodAnalysis_Result MethodResult;
        #endregion

        #region "Constructor"
        public MAS304_MethodAnalysisEntry()
        {
            InitializeComponent();
        }
        public MAS304_MethodAnalysisEntry(sp_MAS304_GetMethodAnalysis_Result data)
        {
            InitializeComponent();
            MethodResult = data;
        }
        ...
        private void InitialScreen()
        {
            try
            {
                ...
                SetControlToValidate(txtName, cboInstitution, txtSeq);
        ...
        private void SaveData()
        {
            ...
            try
            {
                ...
                if (ValidateBeforeSave())
                {
                    ...
                    {
                        int ID = vmMas.SaveMethodAnalysis(MethodResult);
                        rMessageBox.ShowInfomation(this, MessageCode.INF0002);
                        this.IsDataChange = true;
                        MethodResult = vmMas.GetMethodAnalysis(ID);
                        RetriveData();
                    }
                }
            }
        ...
        private void CancelData(bool isCancel)
        {
            ...
            try
            {
                ...
                {
                    vmMas.CancelMethodAnalysis(MethodResult, isCancel);
                    if (isCancel)
                    {
                    ...
                    this.IsDataChange = true;
                    MethodResult = vmMas.GetMethodAnalysis(MethodResult.ID);
                    RetriveData();
                }
            }
            catch (Exception ex)
        ...
        #region "Event"
        private void MAS304_MethodAnalysisEntry_Load(object sender, EventArgs e)
        {
            InitialScreen();
        }

        private void MAS304_MethodAnalysisEntry_OnSave(object sender, EventArgs e)
        {
            SaveData();
        }

        private void MAS304_MethodAnalysisEntry_OnCancel(object sender, EventArgs e)
        {
            CancelData(true);
        }

        private void MAS304_MethodAnalysisEntry_OnRecovery(object sender, EventArgs e)
        {
            CancelData(false);
        }
        #endregion
